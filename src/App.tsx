    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="menu" className="section">
        ...
        <div className="menu-grid">
          {[
            { name: 'Kelewele', category: 'Appetizers', price: 'GH₵15', image: `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/Sky-Lounge-Images/fried_plaintain.webp` },
            { name: 'Jollof', category: 'Main Course', price: 'GH₵50', image: `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/Sky-Lounge-Images/GhanaJollof.webp` },
            { name: 'Grilled chicken', category: 'Main Course', price: 'GH₵40', image: `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/Sky-Lounge-Images/grilled_chicken.webp` },
            { name: 'Grilled chicken Salad', category: 'Salads', price: 'GH₵20', image: `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/Sky-Lounge-Images/GrilledChickenSalad.webp` },
            { name: 'Sobolo', category: 'Desserts', price: 'GH₵10', image: `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/Sky-Lounge-Images/sobolo.jpg` },
            { name: 'Chips', category: 'Desserts', price: 'GH₵10', image: `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/Sky-Lounge-Images/chips.webp` }
          ].map((item, index) => (
